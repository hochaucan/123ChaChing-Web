...
namespace NextTech.ChaChing123.Core.Filters.Helpers
{
    ...
    using System.Text;
    using NextTech.ChaChing123.Core;
    #endregion
    ...
    public sealed class NLogger : ITraceWriter
    {
        ...
        private void Log(TraceRecord record)
        {
            ...
            if (userName != null)
                message.Append("User Name: " + userName + Environment.NewLine);
            ...
            // remove the nLog and replace with EL
            // Logger[record.Level](Convert.ToString(message) + Environment.NewLine);

            // enterprise library logging
            NextTech.ChaChing123.Core.Logging.Logger.Write(Convert.ToString(message) + Environment.NewLine, NextTech.ChaChing123.Core.Models.TraceEventType.INFORMATION);
