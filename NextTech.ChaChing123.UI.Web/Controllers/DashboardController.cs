...
namespace NextTech.ChaChing123.UI.Web.Controllers
{
    ...
    public class DashboardController : ApiController
    {
        ...
        public object Get()
        {
            string allText = System.IO.File.ReadAllText(System.Web.HttpContext.Current.Server.MapPath("~/App_Data/homeAllInOneCategoryContent.json"));
        ...
        {
            var filePath = System.Web.HttpContext.Current.Server.MapPath("~/App_Data/homeAllInOneCategoryContent.json");
        ...
        public object Add(HomeInOneCategoryContentModel entity)
        {
            ...
            string data = System.IO.File.ReadAllText(System.Web.HttpContext.Current.Server.MapPath("~/App_Data/homeAllInOneCategoryContent.json"));
