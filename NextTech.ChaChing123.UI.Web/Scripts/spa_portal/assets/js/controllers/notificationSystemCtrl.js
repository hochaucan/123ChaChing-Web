'use strict';
/** 
  * controller for System Notificatinon
*/

app.controller('NotificationSystemController', ["$scope", "$timeout", "$localStorage", "noticeService", "membershipService", "notificationService",
