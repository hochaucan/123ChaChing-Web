...
(function (angular) {
    app.controller('ModalShowScriptLeadCtrl', ["$scope", "$localStorage", "$timeout", "$uibModalInstance", "items", "responseService", "leadService", "membershipService", "notificationService",
