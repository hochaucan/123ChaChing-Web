'use strict';
/** 
  * controller for New Lead Notification
*/
app.controller('NotificationNewLeadController', ["$scope", "$timeout", "$localStorage", "noticeService", "membershipService", "notificationService",
