...
app.run(['$rootScope', '$state', '$stateParams',
    ...
    $rootScope.app = {
        ...
        layout: {
            ...
            logo: '../Scripts/spa_admin/assets/images/logo.png', // relative path of the project logo
        }
    };
    $rootScope.user = {
        name: 'Peter',
        job: 'ng-Dev',
        picture: '../Scripts/spa_admin/app/img/user/02.jpg'
    };
}]);
// translate config
...
function ($translateProvider) {
    ...
    $translateProvider.useStaticFilesLoader({
        prefix: '../Scripts/spa_admin/assets/i18n/',
        suffix: '.json'
    });
