...
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        'ngTableWithDrawRequestCtrl': virtualDirectory + 'Areas/Admin/Scripts/spa_admin/assets/js/controllers/withDrawRequestCtrl.js',
        ...
        'ngTableAffiliateLinkCategoryManagerCtrl': virtualDirectory + 'Areas/Admin/Scripts/spa_admin/assets/js/controllers/affiliatelinkCategoryManagerCtrl.js',
        'ngTableAffiliateLinkManagerCtrl': virtualDirectory + 'Areas/Admin/Scripts/spa_admin/assets/js/controllers/affiliatelinkManagerCtrl.js',
        'ngTableAffiliateLinkBannerManagerCtrl': virtualDirectory + 'Areas/Admin/Scripts/spa_admin/assets/js/controllers/affiliatelinkBannerManagerCtrl.js',
        ...
        'ngTableFrequentQuestionManagerCtrl': virtualDirectory + 'Areas/Admin/Scripts/spa_admin/assets/js/controllers/frequentQuestionManagerCtrl.js',
        'ngTableContactUsCtrl': virtualDirectory + 'Areas/Admin/Scripts/spa_admin/assets/js/controllers/contactUsCtrl.js',
