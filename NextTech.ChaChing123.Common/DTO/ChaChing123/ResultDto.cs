...
namespace NextTech.ChaChing123.Common.Models
{
    public class ResultDTO
    {
        ...
        public void SetContentMsg() {
            ...
            else if (this.StatusCode == ConvertErrorCodeToInt(RetCode.ECS0030))
            {
                this.statusMsg = RetCodeMsg.ECS0030;
            }
            else if (this.StatusCode == ConvertErrorCodeToInt(RetCode.ECS0031))
            {
                this.statusMsg = RetCodeMsg.ECS0031;
            }
            else if (this.StatusCode == ConvertErrorCodeToInt(RetCode.ECS0032))
            {
                this.statusMsg = RetCodeMsg.ECS0032;
            }
            else if (this.StatusCode == ConvertErrorCodeToInt(RetCode.ECS0033))
            {
                this.statusMsg = RetCodeMsg.ECS0033;
            }
            else if (this.StatusCode == ConvertErrorCodeToInt(RetCode.ECS0034))
            {
                this.statusMsg = RetCodeMsg.ECS0034;
            }
